...
@Autonomous(name = "Red Auto Near Shoot 6", group = "Examples")
public class RedAuto2Shoot6 extends OpMode {
    ...
    private final Pose order2 = new Pose(123, 100, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.
