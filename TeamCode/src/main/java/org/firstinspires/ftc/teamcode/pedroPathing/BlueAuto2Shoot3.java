...
@Autonomous(name = "Blue Auto Near Shoot 3", group = "Examples")
public class BlueAuto2Shoot3 extends OpMode {
    ...
    private final Pose order3 = new Pose(20, 100, Math.toRadians(0)); // Middle (Second Set) of Artifacts from the Spike Mark.
