...
@Autonomous(name = "Blue Auto Near Shoot 6", group = "Examples")
public class BlueAuto2Shoot6 extends OpMode {
    ...
    private final Pose order2 = new Pose(20, 100, Math.toRadians(0)); // Middle (Second Set) of Artifacts from the Spike Mark.
