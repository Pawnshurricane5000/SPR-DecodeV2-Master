...
@Autonomous(name = "Red Auto Near Shoot 3", group = "Examples")
public class RedAuto2Shoot3 extends OpMode {
    ...
    private final Pose order3 = new Pose(123, 100, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.
